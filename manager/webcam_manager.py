...
def FPS(message, classe,previousTime, image):
    ...
    cv2.putText(image, str(int(fps))+" FPS", (10,  image_height-10), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2)  # Displaying FPS on the image
    # cv2.putText(image, str("Classe : "+classe), (10, 180), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,0), 2)
    cv2.putText(image, str(message), (10, 60), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2) 
